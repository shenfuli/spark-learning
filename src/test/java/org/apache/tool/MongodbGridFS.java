...
public class MongodbGridFS {
    public static void main(String[] args) throws Exception {
        String filePath = "src/main/resources/categoryNbayes";
        String key = "categoryNbayes";
        String fileName = "categoryNbayes";
        MongoClient mongoClient = new MongoClient("10.1.1.8", 27017);

        MongodbGridFS mongodbGridFS = new MongodbGridFS("gridfs", mongoClient);
        //把文件保存到gridfs中，并以文件的md5值为id
        mongodbGridFS.save(IOUtils.toByteArray(new FileInputStream(filePath)), key, fileName);
        //据文件名从gridfs中读取到文件
        ...
        gridFSDBFile.writeTo(new File("src/main/resources/my"));
    }
    ...
    public MongodbGridFS(String dbName, MongoClient mongoClient) {
